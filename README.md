# Проект грейдировния в HTML Academy
Задача: самостоятельно выполнить проект в сжатые сроки, с соблюдением технического задания и критериев.

Затраченное время на выполнение проекта: **56 часов**.
